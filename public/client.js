...
var LOGO_FILE = "market/logo_zone.png";
...
function preload() {
    ...
    */
    ...
    var logoSheet = loadSpriteSheet(ASSETS_FOLDER + LOGO_FILE, 64, 82, 4);
...
function showAcknowledgement() {
    var e = document.getElementById("acknowledgement-form");
    if (e != null)
        e.style.display = "block";

    e = document.getElementById("acknowledgement-container");
    if (e != null)
        e.style.display = "block";
}
