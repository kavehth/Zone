...
module.exports.ROOMS = {
    ...
    freeplayOutside: {
        ...
        areaColors: {
            //h will be replaced by #
            //hff77a8: { cmd: "enter", room: "market", label: "Enter Freeplay", point: [100, 84], enterPoint: [116, 69], obstacle: false },
			hff61b2: { cmd: "action", actionId: "EnterNightmarket", label: "Enter Nightmarket", point: [109, 84], obstacle: false },
			h71e392: { cmd: "action", actionId: "GetLanyard", label: "Collect Lanyard", point: [58, 84], obstacle: false },
        }
    },
    ...
    freeplayOutside: {
        ...
        areaColors: {
            //h will be replaced by #
			hff61b2: { cmd: "action", actionId: "EnterScreeningRoom", label: "Enter Screening Room", point: [109, 84], obstacle: false },
			hff61b2: { cmd: "action", actionId: "EnterZone", label: "Enter Zone", point: [109, 84], obstacle: false },
			h71e392: { cmd: "action", actionId: "GetLanyard", label: "Collect Lanyard", point: [58, 84], obstacle: false },
        }
    },
    ...
    backyard: {
        //the background graphics, it can be a spreadsheet
        bg: "market/nightmarket-backyard-daytime-bg.png",
		nightBg: "market/nightmarket-Backyard-nightime-bg.png",
        //if spreadsheet frames
        frames: 2,
        //if animated, animation speed in refreshes (frame dependent)
        frameDelay: 30,
        ...
        //graphics with active areas Sierra Online adventures style
        //color coded as below, #FFFFFF is walkable, transparent is obstacle
        area: "market/nightmarket-Backyard-nighttime-areas.png",
        //each color can trigger a command, the destination needs to be reached first
        //the "h" is replaced by # to identify color
        areaColors: {
            //enter command changes room
            ...
            //enterPoint: where to spawn in the next room
            //obstacle: is the area walkable
			//hfbf236: { cmd: "enter", room: "screeningRoom", label: "Screening Room", point: [14, 85], enterPoint: [114, 86], obstacle: false },
			hfbf236: { cmd: "action", actionId: "EnterZone", label: "Inside", point: [14, 85], obstacle: false },
			hd77bba: { cmd: "text", txt: "\"Bro, they won't even let *me* climb the tree\" - cecile, 2020", align: "left", lines: 2, label: "Climb Tree", point: [105, 83], obstacle: true },
        },
		things: {
            //sprite spreadsheets only 1 row ok?
            middeOfTheHill: { file: "market/merry-game-anim.png", frames: 2, frameDelay: 30, position: [97, 57], label: "Middle of the Hill", command: { cmd: "text", txt: "MIDDLE OF THE HILL\nby Meredith Hall\nClick to play.", align: "left", lines: 3, url: "https://merryh.itch.io/middleofthehill", label: "Middle of the Hill", point: [106, 82] } }
        }
    },
        ...
        frameDelay: 10,
		pageBg: "#000000",
        area: "market/nightmarket-Screening-areas.png",
        tint: "#342c24",
        bubblesY: 60,
        spawn: [15, 77, 113, 96],
        areaColors: {
            //right
            //hff7930: { cmd: "enter", room: "backyard", label: "Backyard", point: [117, 86], enterPoint: [12, 86], obstacle: false },
			hff7930: { cmd: "action", actionId: "MoreZone", label: "More Zone", point: [117, 86], obstacle: false },
			h5182ff: { cmd: "enter", room: "freeplayOutside", label: "Outside", point: [96, 91], enterPoint: [103, 84], obstacle: false },
        }

    },
	
	market:{
        bg: "market/nightmarket-MainSpace-bg.png",
        frames: 2,
        frameDelay: 30,
        avatarScale: 2,
        pageBg: "#ab5236",
        area: "market/nightmarket-MainSpace-areas.png",
        tint: "#fdeac8",
		pageBg: "#000000",
        bubblesY: 44,
        spawn: [17, 80, 110, 90],
        areaColors: {
            //h will be replaced by #
			h9400ff: { cmd: "enter", room: "backyard", label: "Backyard", point: [117, 86], enterPoint: [12, 86], obstacle: false },
			h8e3810: { cmd: "enter", room: "freeplayOutside", label: "Outside", point: [96, 91], enterPoint: [103, 84], obstacle: false },
			hff38ea: { cmd: "enter", room: "screeningRoom", label: "Screening Room", point: [14, 85], enterPoint: [114, 86], obstacle: false },
			h1e5196: { cmd: "enter", room: "weird", label: "Mysterious Room", point: [22, 53], enterPoint: [23, 92], obstacle: false },
			hffe038: { cmd: "text", txt: "IF WE WERE ALLOWED TO VISIT\nby Ian MacLarty & Gemma Mahadeo\nClick to play", align: "left", lines: 3, url: "https://ianmaclarty.com/if-we-were-allowed-to-visit/", label: "If We Were Allowed To Visit", point: [41, 81], obstacle: true },
			hff3838: { cmd: "text", txt: "FIRST DATE/CAN'T RELATE\nby Ruqiyah Patel\nClick to play", align: "left", lines: 3, url: "https://ub4q.itch.io/first-date", label: "first date/can't relate", point: [69, 80], obstacle: true },
			h38ff4d: { cmd: "text", txt: "ENDLESS SCROLL\nby Cecile Richard\nClick to play", align: "left", lines: 3, url: "https://haraiva.itch.io/endless-scroll", label: "Endless Scroll", point: [99, 80], obstacle: true },
        }
    },
	
	
	weird:{
        bg: "market/nightmarket-Weird-bg.png",
        frames: 2,
        frameDelay: 30,
        avatarScale: 2,
        pageBg: "#ab5236",
        area: "market/nightmarket-Weird-areas.png",
        tint: "#fdeac8",
		pageBg: "#000000",
        bubblesY: 44,
        spawn: [17, 80, 110, 90],
        areaColors: {
            //h will be replaced by #
			hd77bba: { cmd: "enter", room: "market", label: "Market", point: [23, 92], enterPoint: [21, 74], obstacle: false },
			h5b6ee1: { cmd: "text", txt: "SOMETHING LOOKS WEIRD\nby Chris Gebbing\nClick to play", align: "left", lines: 3, url: "https://gebbo.itch.io/something-looks-weird", label: "Something Looks Weird", point: [25, 83], obstacle: true },
			h99e550: { cmd: "text", txt: "ALEPH {a life}\nby Mohamed Chamas\nClick to play", align: "left", lines: 3, url: "https://mochamas.itch.io/aleph", label: "ALEPH", point: [92, 76], obstacle: true },
        }
    }
};